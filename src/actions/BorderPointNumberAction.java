...
public class BorderPointNumberAction extends AbstractAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (result == JOptionPane.OK_OPTION) {		
			MyPoint[] borderPoints;
			
			if(!forAll.isSelected()){
				int[] numbers = {Integer.parseInt(num1.getText())};
				borderPoints = window.getCurrentRegion().generateBorderByNumber(numbers, forAll.isSelected());	
			}else{
				int[] numbers = {Integer.parseInt(num1.getText()), Integer.parseInt(num2.getText()),
						         Integer.parseInt(num3.getText()), Integer.parseInt(num4.getText())};
				borderPoints = window.getCurrentRegion().generateBorderByNumber(numbers, forAll.isSelected());
			}		
